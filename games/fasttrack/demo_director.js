...
// ============================================================
// Loaded via ?demo=1 URL parameter on board_3d.html
//
...
(function() {
    ...
    function createCTAOverlay() {
        ...
        ctaBar.innerHTML = `
            ...
            <a href="board_3d.html" id="demo-play-btn" onclick="if(window.FTAnalytics)FTAnalytics.ctaClick('demo_play_now')" style="
    ...
    function hideAllUI() {
        const ids = [
            ...
            'camera-panel', 'card-draw-area',
            'debug-panel', 'card-rule-popup', 'auth-container',
            'lobby-container', 'exit-game-btn',
        ];
        ids.forEach(id => {
    ...
    // board_3d.html defines it in a script block.
