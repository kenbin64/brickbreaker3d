...
// NOTE: All hole counts and IDs are defined in BOARD_TOPOLOGY (board_manifold.js).
//       Do NOT duplicate or re-derive topology values here.
const BoardSubstrate = {
    version: '2.0.0',
    name: 'FastTrack Board Topology',

    // Board zones — counts sourced from BOARD_TOPOLOGY
    zones: {
        HOLDING: {
            id: 'holding',
            description: 'Starting area for pegs not yet on board',
            perPlayer: 4,  // BOARD_TOPOLOGY.HOLDING_HOLES_PER_PLAYER
            isSafe: true
        },
        OUTER_TRACK: {
            id: 'outer',
            description: 'Main perimeter track around the hexagonal board',
            holesPerSide: 4,   // BOARD_TOPOLOGY.SIDE_HOLES_PER_SIDE
            holesPerSection: 14, // BOARD_TOPOLOGY.HOLES_PER_SECTION
            totalPerimeter: 84,  // BOARD_TOPOLOGY.PERIMETER_HOLES
            isSafe: false
        },
        FAST_TRACK: {
            id: 'fasttrack',
            description: 'Inner ring shortcut (pentagon corners)',
            holes: 6,  // BOARD_TOPOLOGY.FASTTRACK_HOLES
            isSafe: false
        },
        BULLSEYE: {
            id: 'bullseye',
            description: 'Center hole - gateway to fast track',
            holes: 1,  // BOARD_TOPOLOGY.BULLSEYE_HOLES
            isSafe: true
        },
        SAFE_ZONE: {
            id: 'safezone',
            description: 'Final stretch before home (per player)',
            perPlayer: 4,  // BOARD_TOPOLOGY.SAFE_ZONE_HOLES_PER_PLAYER
            isSafe: true
        },
        HOME: {
            id: 'home',
            description: 'Final destination for each player (diamond marker)',
            perPlayer: 1,  // BOARD_TOPOLOGY.HOME_HOLES / PLAYERS
            isSafe: true
        }
    },
